...
namespace BL
{
    ...
    {
        public static ML.Result CandidatoGetAll(int IdVacante)
        {
            ...
            try
            {
                ...
                {
                    var tableusuario = context.CandidatoVacantes.FromSqlRaw($"EXEC CandidatoGetAll {IdVacante}").ToList();
                    if (tableusuario.Count > 0)
                    {
                        ...
                        foreach (var item in tableusuario)
                        {
                            ...
                            candidato.Edad = item.Edad;
                            candidato.Correo = item.Correo;
                            candidato.Telefono = item.Telefono;
                            candidato.Direccion = item.Direccion;
                            candidato.Vacante.Nombre = item.NombreVacante;
                            candidato.Cita.IdCita = item.IdCita;

                            if (item.Foto != null)
                            {
                                candidato.Foto = item.Foto;
                                candidato.FotoBase64 = Convert.ToBase64String(candidato.Foto);
                            }
                            if (item.Curriculum != null)
                            {
                                candidato.Curriculum = item.Curriculum;
                                candidato.CurriculumBase64 = Convert.ToBase64String(candidato.Curriculum);
                            }
                            candidato.Vacante.IdVacante = item.IdVacante;
                    ...
                    else
                    {
                        ...
                        result.ErrorMessage = "No hay candidatos para mostrar";
                    }
                }
            }
            catch (Exception e)
        ...
        public static ML.Result CandidatoGetById(int Id)
        {
            ML.Result result = new ML.Result();
            try
            {
                using (DL.ReclutamientoDigisContext context = new DL.ReclutamientoDigisContext())
                {
                    var Candidato = context.CandidatoVacantes.FromSqlRaw($"EXEC CandidatoGetById {Id}").AsEnumerable().FirstOrDefault();
                    ...
                    if (Candidato != null)
                    {
                        ...
                        ML.Candidato candidato = new ML.Candidato();
                        candidato.Cita = new ML.Cita();
                        candidato.Cita.Piso = new ML.Piso();
                        candidato.Cita.EstatusCita = new ML.EstatusCita();
                        candidato.Vacante = new ML.Vacante();
                        candidato.IdCandidato = Candidato.IdCandidato;
                        candidato.Nombre = Candidato.Nombre;
                        candidato.ApellidoPaterno = Candidato.ApellidoPaterno;
                        candidato.ApellidoMaterno = Candidato.ApellidoMaterno;
                        candidato.Edad = Candidato.Edad;
                        ...
                        candidato.Vacante.IdVacante = Candidato.IdVacante;
                        candidato.Cita.IdCita = Candidato.IdCita;
                        if (Candidato.FechaHora != null)
                        {
                            candidato.Cita.FechaHora = Candidato.FechaHora.Value.ToString("yyyy-MM-dd HH:mm:ss");
                        }

                        candidato.Cita.Url = Candidato.Url;
                        candidato.Cita.Piso.IdPiso = Candidato.IdPiso;
                        candidato.Cita.EstatusCita.IdEstatusCita = Candidato.IdEstatusCita;
        ...
        public static ML.Result CandidatoAdd(ML.Candidato candidato)
        {
            ML.Result result = new ML.Result();
            try
            {
                using (DL.ReclutamientoDigisContext context = new DL.ReclutamientoDigisContext())
                {
                    ...
                    if (candidato.Foto == null)
                    {
                        rowsaffected = context.Database.ExecuteSqlRaw($"CandidatoAdd '{candidato.Nombre}', '{candidato.ApellidoPaterno}', '{candidato.ApellidoMaterno}', '{candidato.Edad}', '{candidato.Correo}', '{candidato.Telefono}', '{candidato.Direccion}', null ,  null, {candidato.Vacante.IdVacante}");
                    }
                    else
                    {
                        rowsaffected = context.Database.ExecuteSqlRaw(
                            "CandidatoAdd @Nombre, @ApellidoPaterno, @ApellidoMaterno, @Edad, @Correo, @Telefono, @Direccion, @Foto, null, @IdVacante",
                              new SqlParameter("@Nombre", candidato.Nombre),
                              new SqlParameter("@ApellidoPaterno", candidato.ApellidoPaterno),
                              new SqlParameter("@ApellidoMaterno", candidato.ApellidoMaterno),
                              new SqlParameter("@Edad", candidato.Edad),
                              new SqlParameter("@Correo", candidato.Correo),
                              new SqlParameter("@Telefono", candidato.Telefono),
                              new SqlParameter("@Direccion", candidato.Direccion),
                              new SqlParameter("@Foto", candidato.Foto),
                              new SqlParameter("@IdVacante", candidato.Vacante.IdVacante)
                        );
                    }
        ...
        public static ML.Result CandidatoUpdate(ML.Candidato candidato)
        {
            ML.Result result = new ML.Result();
            try
            {
                using (DL.ReclutamientoDigisContext context = new DL.ReclutamientoDigisContext())
                {
                    ...
                    if (candidato.Foto == null)
                    {
                        rowsaffected = context.Database.ExecuteSqlRaw($"CandidatoUpdate {candidato.IdCandidato},'{candidato.Nombre}', '{candidato.ApellidoPaterno}', '{candidato.ApellidoMaterno}', '{candidato.Edad}', '{candidato.Correo}', '{candidato.Telefono}', '{candidato.Direccion}', null ,  null, {candidato.Vacante.IdVacante}");
                    }
                    else
                    {
                        rowsaffected = context.Database.ExecuteSqlRaw(
                            "CandidatoUpdate @IdCandidato ,@Nombre, @ApellidoPaterno, @ApellidoMaterno, @Edad, @Correo, @Telefono, @Direccion, @Foto, null, @IdVacante",
                              new SqlParameter("@IdCandidato", candidato.IdCandidato),
                              new SqlParameter("@Nombre", candidato.Nombre),
                              new SqlParameter("@ApellidoPaterno", candidato.ApellidoPaterno),
                              new SqlParameter("@ApellidoMaterno", candidato.ApellidoMaterno),
                              new SqlParameter("@Edad", candidato.Edad),
                    ...
                    {
                        result.ErrorMessage = "Ocurrió un error al actualizar el registro";
                        result.Correct = false;
                    }
                }
            }
        ...
        public static ML.Result CandidatoDelete(int IdCandidato)
        {
            ML.Result result = new ML.Result();
            try
            {
                using (DL.ReclutamientoDigisContext context = new DL.ReclutamientoDigisContext())
                {
                    var rowsaffected = context.Database.ExecuteSqlRaw($"CandidatoDelete {IdCandidato}");
